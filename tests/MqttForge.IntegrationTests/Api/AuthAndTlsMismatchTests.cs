...
public class WrongCredentialsTests : IClassFixture<MqttForgeApiFactory>, IClassFixture<LockedMosquittoFixture>
{
    private readonly MqttForgeApiFactory _factory;
    private readonly LockedMosquittoFixture _broker;

    public WrongCredentialsTests(MqttForgeApiFactory factory, LockedMosquittoFixture broker)
    {
        _factory = factory;
        _broker = broker;
    }
...
public class TlsMismatchTests : IClassFixture<MqttForgeApiFactory>, IClassFixture<MosquittoFixture>
{
    private readonly MqttForgeApiFactory _factory;
    private readonly MosquittoFixture _broker;

    public TlsMismatchTests(MqttForgeApiFactory factory, MosquittoFixture broker)
    {
        _factory = factory;
        _broker = broker;
    }
