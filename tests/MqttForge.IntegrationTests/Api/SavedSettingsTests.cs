...
public class SavedSettingsTests : IClassFixture<MqttForgeApiFactory>, IClassFixture<MosquittoFixture>
{
    private readonly MqttForgeApiFactory _factory;
    private readonly MosquittoFixture _broker;

    public SavedSettingsTests(MqttForgeApiFactory factory, MosquittoFixture broker)
    {
        _factory = factory;
        _broker = broker;
    }
